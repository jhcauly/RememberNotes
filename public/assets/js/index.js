...
const renderActiveNote = () => {
  ...
  if (activeNote.notes_id) {
    console.log(activeNote.notes_id )
...
const handleNoteDelete = (e) => {
  ...
  const note = e.target;
  /* console.log(note.parentElement.getAttribute('data-note')).notes_id; */
...
const idNotes = noteId.notes_id;
  deleteNote(idNotes).then(() => {
    getAndRenderNotes();
    renderActiveNote();
  });
};
...
const renderNoteList = async (notes,aux) => {
 ...
 console.log(jsonNotes)
  ...
  const createLi = (node, delBtn = true) => {
